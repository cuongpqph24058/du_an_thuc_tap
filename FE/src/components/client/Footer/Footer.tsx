...
const Footer = () => {
  ...
  const link2 = [
    { name: "Hướng dẫn mua hàng", url: "/faq" },
    { name: "Phương thức thanh toán", url: "/" },
    { name: "Phương thức vận chuyển", url: "/" },
    { name: "Chính sách bồi hoàn", url: "/" },
  ...
  return (
    <>
      <footer className="w-full  mt-10">
        <Container>
              <div className="flex flex-col justify-between border-t border-gray-800 sm:flex-row">
